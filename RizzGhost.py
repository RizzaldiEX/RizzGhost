...
#      Sorry i rebuild your code:)
#      ReCoded By RizzaldiEX.
...
# RIZALDI GANTENG
 logo = ''' \033[0;96m ____  ___ __________
  \033[0;96m  | _ \|_ _|__  /__  / ® \033[0m|| Created By RizzaldiEX
  \033[0;96m  | |_) || |  / /  / /     \033[0m|| Github.com/RizzaldiEX
  \033[0;96m  |  _ < | | / /_ / /_ \033[0;91mv2.0  \033[0m|| Status/Premium
  \033[0;96m  |_| \_\___/____/____| \033[0m|| KondangSejagat

lo_ngentod = '711886636449238'
# crack selesai
def hasil(ok,cp):
...
# Yang ganti bot nya gw sumpahin harimu suram!
def wuhan(kontol):
    try:
        kentod = kontol
...
class __crack__:
    ...
    def __pler__(self):
        ...
        if yan == '':
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = ["anjing", "123456", "ngentod", "setiahati", "sayang", "bismillah, "doraemon", "Indonesia", "dancok", "rahasia", "katasandi", "lampung", "doraemon", "sayangku", "akucantik", "qwerty"]
            ...
            print '\n %s[%s×%s] input yang bener sayang'%(N,M,N);self.__pler__()
